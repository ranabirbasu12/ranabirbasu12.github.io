...
/* ------------------------------------------
   ...
   ------------------------------------------ */
const SKILLS_DATA = [
    { id: 'math', name: 'Calculus Notes', icon: '📐', desc: 'Survived freshman math.', xpReq: 10 },
    { id: 'python', name: 'Python Scripts', icon: '🐍', desc: 'Learned to code.', xpReq: 30 },
    { id: 'bicycle', name: 'Campus Bicycle', icon: '🚲', desc: 'Navigated the huge campus.', xpReq: 50 },
    { id: 'sql', name: 'SQL Queries', icon: '🗄️', desc: 'Data extraction mastery.', xpReq: 80 },
    { id: 'abtest', name: 'A/B Spreadsheets', icon: '📊', desc: 'Analyzed user behavior.', xpReq: 110 },
    { id: 'pizza', name: 'Cold Pizza', icon: '🍕', desc: 'Fueled late nights.', xpReq: 140 },
    { id: 'finmod', name: 'Financial Models', icon: '📈', desc: 'Built DCF models.', xpReq: 160 },
    { id: 'coffee', name: 'Espresso', icon: '☕', desc: 'Liquid energy.', xpReq: 190 },
    { id: 'cfa', name: 'CFA Prep', icon: '📚', desc: 'Read 3000 pages.', xpReq: 220 },
    { id: 'memos', name: 'Credit Memos', icon: '📝', desc: 'Wrote investment thesis.', xpReq: 250 }
];
